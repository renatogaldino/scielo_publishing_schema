...
autor, as quais deverão ser identificadas em :ref:`elemento-author-notes`. Pode possuir um único título identificado com a tag ``<title>``  e uma ou mais notas :ref:`elemento-fn`.
